package PRIMUS::PRIMUS_plus_ERSA_only_unrel;
...
sub get_max_composite_score_two_pedigrees
{
	...
	print "Before build network";
	print "$fam_file1";
	my $network1 = build_network_from_ped_file($fam_file1);
	print "Between build networks";
	print "$fam_file2";
	my $network2 = build_network_from_ped_file($fam_file2);
	print "After build network";	
